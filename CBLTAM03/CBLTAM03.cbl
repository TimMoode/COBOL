      ...
      * COMPANY WHO SELLS BOATS
       ...
       FILE-CONTROL.
           ...
           SELECT PRTOUT
               ASSIGN TO 'C:\COBOLWI19\PAPER_BOATS03.PRT'
       ...
       01 MISC.
         ...
         05 CMINNUMSOLD            PIC 9(10)       VALUE 0.
         05 CMAJNUMSOLD            PIC 9(10)       VALUE 0.
         05 CMINTOTCOST            PIC 9(9)V99     VALUE 0.
         05 CMAJTOTCOST            PIC 9(9)V99     VALUE 0.
         05 CMINBOATCOST           PIC 9(9)V99     VALUE 0.
         05 CMAJBOATCOST           PIC 9(9)V99     VALUE 0.
       ...
       01  H-MINORSUBTOTALS.
           ...
           05 OLDSTATE             PIC XX.
           05 FILLER               PIC X(11)       VALUE SPACES.
           05 MINBOATCOST          PIC $$,$$$,$$$V99.
           05 FILLER               PIC X(10)       VALUE SPACES.
           05 FILLER               PIC X(15)       VALUE 'NUMBER SOLD:   '.
           05 MINNUMSOLD           PIC Z,ZZ9.
           05 FILLER               PIC X(37)       VALUE SPACES.
           05 MINTOTCOST           PIC $$$$,$$$,$$$.99.
       01  H-GRANDTOTALS.
           05 FILLER               PIC X(23)       VALUE SPACES.
       ...
       L1-MAINLINE.
           IF HOLDTHESAILS NOT EQUAL I-BOAT-TYPE
               ...
               PERFORM L7-MAJOR
           END-IF.
           IF STATEHOLD NOT EQUAL I-STATE
               PERFORM L7-MINOR
           END-IF.
           PERFORM L2-CALCS.
           PERFORM L2-OUTPUT.
       ...
       L2-CALCS.
           ...
           COMPUTE CMINNUMSOLD = CMINNUMSOLD + 1.
           COMPUTE CMINTOTCOST = CMINTOTCOST + CTOTALCOST.
           COMPUTE CMINBOATCOST = CMINBOATCOST + I-BOAT-COST.
           PERFORM L9-BOATTYPE.
      ...
      * TOTAL-COST IS NOT WORKING. AT. ALL.
       ...
       L3-HEADINGS.
           ...
           WRITE PRTLINE
             FROM BLANKLINE
             AFTER ADVANCING 1 LINE.
           MOVE I-STATE TO STATEHOLD.

       L7-MINOR.
           COMPUTE CMAJTOTCOST = CMAJTOTCOST + CMINTOTCOST.
           COMPUTE CMAJNUMSOLD = CMAJNUMSOLD + CMINNUMSOLD.
           COMPUTE CMAJBOATCOST = CMAJBOATCOST + CMINBOATCOST.
           MOVE STATEHOLD TO OLDSTATE.
           MOVE CMINTOTCOST TO MINTOTCOST.
           MOVE CMINNUMSOLD TO MINNUMSOLD.
           MOVE CMINBOATCOST TO MINBOATCOST.
           WRITE PRTLINE
           ...
           WRITE PRTLINE
             ...
             AFTER ADVANCING 1 LINE
               AT END-OF-PAGE
                   PERFORM L3-HEADINGS.
           COMPUTE CMINBOATCOST = 0.
           COMPUTE CMINNUMSOLD = 0.
           COMPUTE CMINTOTCOST = 0.
           MOVE I-STATE TO STATEHOLD.

       L7-MAJOR.
           COMPUTE CGTSOLD = CGTSOLD + CMAJNUMSOLD.
           COMPUTE CGTTOTALCOST = CGTTOTALCOST + CMAJTOTCOST.
      * COMEDIAN IN THE MAKING
           MOVE H-BOATTYPE TO BOATDOCK.
           MOVE CMAJNUMSOLD TO O-NUMSOLD.
           MOVE CMAJTOTCOST TO O-BOATSCOST.
           WRITE PRTLINE
             FROM H-MAJORSUBTOTALS
             AFTER ADVANCING 2 LINES.
           ...
           IF EOF = "N"
               WRITE PRTLINE
                 ...
                 AFTER ADVANCING 2 LINES
           END-IF.
           COMPUTE CMAJTOTCOST = 0.
           COMPUTE CMAJNUMSOLD = 0.
           IF EOF = "N"
               WRITE PRTLINE
                 FROM BLANKLINE
                 AFTER ADVANCING 1 LINE
